---
title: XIAOE App
description: XIAOE App is the reference implementation of what a production XIAOE experience looks like. It assembles the Harness runtime, a web-based conversation workspace, an API gateway, and a reverse proxy into a single deployable system.
---
...
<Callout type="info" emoji="🚀">
  XIAOE App is a complete Super Agent application built on top of XIAOE
...
XIAOE App is the reference implementation of what a production XIAOE experience looks like. It assembles the Harness runtime, a web-based conversation workspace, an API gateway, and a reverse proxy into a single deployable system.
...
The XIAOE App runs behind a single nginx reverse proxy:
...
| Agent runtime     | LangGraph, LangChain, XIAOE Harness                               |
| Reverse proxy     | nginx                                                                |
