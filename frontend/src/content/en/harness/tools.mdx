...
<Callout type="info" emoji="🔧">
  Tools are the actions the Lead Agent can take. XIAOE provides built-in
...
XIAOE organizes tools into four categories:
...
through XIAOE's artifact system. This is useful for visual evidence, UI checks,
