...
description: This tutorial shows you how to use the XIAOE Harness programmatically — importing and using XIAOE directly in your Python code rather than through the web interface.
---
...
This tutorial shows you how to use the XIAOE Harness programmatically — importing and using XIAOE directly in your Python code rather than through the web interface.

## Prerequisites

- Python 3.12+
- `uv` installed
- XIAOE repository cloned
