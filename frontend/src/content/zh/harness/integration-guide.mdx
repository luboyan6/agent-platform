---
title: 集成指南
description: 小易 Harness 不仅仅是一个独立应用程序——它是一个可以导入并在你自己的后端、API 服务器、自动化系统或多 Agent 协调器中使用的 Python 库。
---
...
<Callout type="info" emoji="🔌">
  小易 Harness 可以嵌入任何 Python 应用程序。本指南涵盖在你自己的系统中将
  小易 作为库使用的集成模式。
</Callout>

小易 Harness 不仅仅是一个独立应用程序——它是一个可以导入并在你自己的后端、API 服务器、自动化系统或多 Agent 协调器中使用的 Python 库。
...
小易 Gateway 本身是一个 FastAPI 应用程序。你可以将其作为子应用程序挂载：
